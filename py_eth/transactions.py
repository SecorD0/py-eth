...
from py_eth.data.models import (
...
class Tx(AutoRepr):
    ...
    def decode_input_data(self, client, contract: types.Contract) -> Tuple[Optional[str], Optional[Dict[str, Any]]]:
        """
    ...
    def find_txs(
        ...
        if isinstance(contract, list):
            for contract_ in contract:
                contract_address, abi = self.client.contracts.get_contract_attributes(contract_)
